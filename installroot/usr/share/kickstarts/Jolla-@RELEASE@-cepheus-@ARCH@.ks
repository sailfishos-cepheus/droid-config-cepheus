# DisplayName: Jolla cepheus/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: cepheus
# DeviceVariant: cepheus
# Brand: Jolla
...
repo --name=adaptation-common-cepheus-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-cepheus-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-cepheus
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/cepheus
